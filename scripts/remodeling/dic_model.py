...
class DiC(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.dt_embedder_ls = nn.ModuleList([TimestepEmbedder(hidden_size*mult) for mult in mult_channels[:self.levels]])
    ...
    def initialize_weights(self):
        ...
        for t_embedder in self.dt_embedder_ls:
            nn.init.normal_(t_embedder.mlp[0].weight, std=0.02)
            nn.init.normal_(t_embedder.mlp[2].weight, std=0.02)
    ...
    def forward(self, x, t,dt, y):
        ...
        for idx in range(self.levels):
            ...
            dt_emb = self.t_embedder_ls[idx](dt)    # (N, C, 1, 1)
            ...
            cond_ls.append(t_emb + y_emb+dt_emb)
